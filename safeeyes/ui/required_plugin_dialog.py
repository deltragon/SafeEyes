...
class RequiredPluginDialog(Gtk.ApplicationWindow):
    ...
    def __init__(self, plugin_id, plugin_name, message, on_quit, on_disable_plugin, application):
        super().__init__(application=application)

        self.on_quit = on_quit
        self.on_disable_plugin = on_disable_plugin

        self.lbl_header.set_label(_("The required plugin '%s' is missing dependencies!") % _(plugin_name))
